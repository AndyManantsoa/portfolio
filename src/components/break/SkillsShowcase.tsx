            ...
            <div className="mt-8 grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
              {activeSection.cards.map((card) => (
                <motion.article
                  ...
                  className="group rounded-2xl border border-slate-700/80 bg-slate-900/70 p-5 text-center shadow-[inset_0_1px_0_rgba(148,163,184,0.08)] transition-all duration-200 hover:border-emerald-400/50 hover:bg-[#101f35] hover:shadow-[0_0_0_1px_rgba(16,185,129,0.15),0_16px_32px_rgba(14,116,144,0.12)]"
                >
