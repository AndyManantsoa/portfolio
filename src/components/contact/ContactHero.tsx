...
const contacts = [
  {
    name: "GitHub",
    description: "Code, projects, and work in progress.",
  ...
  {
    name: "Instagram",
    description: "A little beyond the code.",
      ...
      <div className={shared.container}>
        <header className={styles.header}>
          ...
          <p className={styles.intro}>
            Development, web security, collaboration, or opportunities — feel
            free to reach out.
          </p>
        </header>
        ...
        <div className={styles.columns}>
          ...
          >
            ...
            <h2 id="email-heading" className={shared.heading}>
              Let&apos;s talk.
            </h2>
            <p className={styles.description}>
              A few words about you and what you have in mind is a great place
              to start.
            </p>
            ...
            <div className={styles.actions}>
              ...
              <a
                href="/resume/andy-manantsoa-resume.pdf"
                download
            ...
            <p className={styles.feedback} role="status">
              {copyStatus === "error"
                ? "Couldn’t copy the address. Select it above, or use Write an email."
                : copyStatus === "copied"
          ...
          >
            ...
            <h2 id="social-heading" className={styles.socialHeading}>
              Find me online.
            </h2>
